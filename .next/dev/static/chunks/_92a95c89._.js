...
function AIChatbot() {
    ...
    const [currentUser, setCurrentUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    currentUser ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-xs capitalize bg-white/20 text-white px-2 py-1 rounded-full ml-2",
...
_s(AIChatbot, "68DiaXfyZ6tUje0M9uwtJN+vORQ=");
_c = AIChatbot;
var _c;
...
"[project]/components/user-guard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserGuard.useEffect": ()=>{
            try {
                ...
                if (!originalSetItem.__user_guard_wrapped) {
                    const wrappedSetItem = {
                        "UserGuard.useEffect.wrappedSetItem": function(key, value) {
                            try {
                                if (key === "user") {
                                    let parsed = null;
                                    try {
                                    ...
                                    if (!hasUserIdentifier) {
                                        console.warn('[user-guard] Blocked localStorage.user write (missing user identifier)', {
                                            value
                                        });
                                        return;
                                    }
                                    ...
                                    const current = raw ? ({
                                        "UserGuard.useEffect.wrappedSetItem": ()=>{
                                            try {
                                    ...
                                    })["UserGuard.useEffect.wrappedSetItem"]() : null;
                                    if (current && parsed && parsed._id && current._id && String(parsed._id) !== String(current._id)) {
                                        console.warn('[user-guard] Blocked localStorage.user write for different user id', {
                                            currentId: current._id,
                                            incomingId: parsed._id
                                        });
                                        return;
                                    }
                                }
                    ...
                    wrappedSetItem.__user_guard_wrapped = true;
                ...
                if (!originalDispatch.__user_guard_wrapped) {
                    const wrappedDispatch = {
                        "UserGuard.useEffect.wrappedDispatch": function(evt) {
                            try {
                                if (evt && evt.type === 'user-updated') {
                                    ...
                                    const raw = win.localStorage.getItem('user');
                                    const current = raw ? ({
                                        "UserGuard.useEffect.wrappedDispatch": ()=>{
                                            try {
                                                return JSON.parse(raw);
                                            } catch (e) {
                                                return null;
                                    ...
                                    })["UserGuard.useEffect.wrappedDispatch"]() : null;
                                    if (current && payload && payload._id && current._id && String(payload._id) !== String(current._id)) {
                                        console.warn('[user-guard] Blocked user-updated event for different user id', {
                                            currentId: current._id,
                                            incomingId: payload._id
                                        });
                                        return false;
                                    }
                                }
                    ...
                    wrappedDispatch.__user_guard_wrapped = true;
...
_s(UserGuard, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = UserGuard;
var _c;
__turbopack_context__.k.register(_c, "UserGuard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_92a95c89._.js.map