...
function DonorDashboard() {
    ...
    // Step 1 — Get donorId from JWT token
        ...
        "DonorDashboard.useEffect": ()=>{
            ...
            if (token) {
                try {
                    ...
                    setDonorId(decoded.userId); // backend should put userId inside token
                } catch (err) {
    ...
    // Step 2 — Fetch donation history when donorId is available
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DonorDashboard.useEffect": ()=>{
            if (!donorId) return;
            fetch(`http://localhost:5000/api/donor/history/${donorId}`).then({
                "DonorDashboard.useEffect": (res)=>res.json()
            }["DonorDashboard.useEffect"]).then({
                "DonorDashboard.useEffect": (data)=>setHistory(data)
            }["DonorDashboard.useEffect"]).catch({
                "DonorDashboard.useEffect": (err)=>console.error(err)
            }["DonorDashboard.useEffect"]);
        }
    }["DonorDashboard.useEffect"], [
        donorId
    ]);
    // Step 3 — Fetch urgent requests (no login needed)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DonorDashboard.useEffect": ()=>{
            fetch("http://localhost:5000/api/donor/requests").then({
                "DonorDashboard.useEffect": (res)=>res.json()
            }["DonorDashboard.useEffect"]).then({
                "DonorDashboard.useEffect": (data)=>setRequests(data)
            }["DonorDashboard.useEffect"]).catch({
                "DonorDashboard.useEffect": (err)=>console.error(err)
            }["DonorDashboard.useEffect"]);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            !donorId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "text-red-500",
                children: "Loading donor information..."
            }, void 0, false, {
                fileName: "[project]/app/donor/dashboard/page.tsx",
                lineNumber: 48,
                columnNumber: 9
...
_s(DonorDashboard, "EeHgtp43BfMYE5vRxTzxpRkGx4w=");
_c = DonorDashboard;
var _c;
...
//# sourceMappingURL=_d766f99e._.js.map